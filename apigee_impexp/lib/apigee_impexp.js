...
//================================================================================
// added functions for import/export Apigee Caches
...
exports.getCacheList = function(apigee_profile, type, callback, includeCurl){
	var	apigeel = apigee_profile;
	//grunt.log.writeln('Retrieving KVMs at environment level meow...' + apigeel.url_mgmt);
	var options = {
...
exports.getCachesOrganization = function(apigee_profiles, callback, includeCurl){
	var apigeel = apigee_profiles;//[apigee_profiles.env];
	var options = {
      uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/caches",
      method : 'GET',
      auth : {user : apigeel.username, password: apigeel.password}
    };
	if(includeCurl)
...
exports.getCachesEnvironment = function(apigee_profile, callback, includeCurl){
	var apigeel = apigee_profile;//apigee_profiles[apigee_profiles.env];
	var options = {
...
exports.updateCachesEnvironment = function(apigee_profiles, cache, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
...
exports.updateCachesOrganization = function(apigee_profiles, cache, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/caches/" + cache.name,
		method : 'PUT',
		auth : {user : apigeel.username, password: apigeel.password},
		headers : {'Content-Type': 'application/json'},
		body: JSON.stringify(cache)
...
exports.createCachesEnvironment = function(apigee_profiles, cache, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/environments/" + apigeel.env + "/caches",
		method : 'POST',
...
exports.createCachesOrganization = function(apigee_profiles, cache, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/caches",
		method : 'POST',
...
//================================================================================
// added functions for import/export Apigee targetServers
exports.getTargetServer = function(apigee_profile, targetServerName, type, callback, includeCurl){
	var apigeel = apigee_profile;
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + ( type === 'env' ? "/environments/" + apigeel.env : "" ) + '/targetservers/' + targetServerName,
		method : 'GET',
		auth : {user : apigeel.username, password : apigeel.password}
	};
	if(includeCurl)
...
exports.getTargetServersList = function(apigee_profile, type, callback, includeCurl){
	var	apigeel = apigee_profile;
	//grunt.log.writeln('Retrieving KVMs at environment level meow...' + apigeel.url_mgmt);
	var options = {
...
exports.getTargetServersOrganization = function(apigee_profiles, callback, includeCurl){
	var apigeel = apigee_profiles;//[apigee_profiles.env];
	var options = {
      uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/targetservers",
      method : 'GET',
      auth : {user : apigeel.username, password: apigeel.password}
    };
	if(includeCurl)
...
exports.getTargetServersEnvironment = function(apigee_profile, callback, includeCurl){
	var apigeel = apigee_profile;//apigee_profiles[apigee_profiles.env];
	var options = {
...
exports.updateTargetServersEnvironment = function(apigee_profiles, targetServer, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
...
exports.updateTargetServersOrganization = function(apigee_profiles, targetServer, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/targetservers/" + targetServer.name,
		method : 'PUT',
		auth : {user : apigeel.username, password: apigeel.password},
		headers : {'Content-Type': 'application/json'},
		body: JSON.stringify(targetServer)
...
exports.createTargetServersEnvironment = function(apigee_profiles, targetServer, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/environments/" + apigeel.env + "/targetservers",
		method : 'POST',
...
exports.createTargetServersOrganization = function(apigee_profiles, targetServer, callback, includeCurl){
	var apigeel = apigee_profiles[apigee_profiles.env];
	var options = {
		uri : apigeel.url_mgmt + '/v1/organizations/' + apigeel.org + "/targetservers",
		method : 'POST',
